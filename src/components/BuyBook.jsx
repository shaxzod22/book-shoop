  ...
  return (
    ...
    <div className="flex pt-[120px] lg:pt-0 justify-center flex-wrap lg:ml-[78px] gap-y-[140px] lg:gap-y-[69px] gap-x-[100px] 2xl:gap-x-[147px]">
      {bookArr && bookArr.slice(0,8).map((book,index)=>(
           <Link to={`/book/${book.id}`} key={index} className="3xl:w-[384px] rounded-lg 2xl:rounded-none max-w-[600px] xl:w-[384px] 2xl:w-[600px] relative bg-white px-7 lg:pt-[29px] pr-[33px] lg:pl-[104px] pt-[140px] pb-[27px]">
